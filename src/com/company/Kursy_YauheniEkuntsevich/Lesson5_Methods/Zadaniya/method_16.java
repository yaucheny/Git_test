...
public class method_16 {
    public static void main(String[] args) {
        System.out.println(moreThenFive(3));

    }

    static boolean moreThenFive(int a) {
        return (a > 5);
    }

    public static class thema5 {
        public static void main(String[] args) {
    ...
    public static class method {static int minNumberPrint(int a, int b){
        if (a>b){
            return b;
        }
        else{
        ...
        public static void main(String[] args){
            System.out.println( minNumberPrint(10,13) );
        }
